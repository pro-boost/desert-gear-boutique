      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2 className="text-2xl font-heading font-semibold mb-4">{t('returnPolicy')}</h2>
            <p className="text-muted-foreground mb-6">
              {t('returnPolicyDescription')}
            </p>
            
            <h2 className="text-2xl font-heading font-semibold mb-4">{t('howToReturn')}</h2>
            ...
            <h2 className="text-2xl font-heading font-semibold mb-4">{t('refunds')}</h2>
            <p className="text-muted-foreground mb-6">
              {t('refundDescription')}
            </p>
          </div>
