          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="flex items-center space-x-3 mb-4">
                {hasDiscount ? (
                  <>
                    <span className="text-2xl font-bold">{product.discountPrice?.toFixed(2)} Dh</span>
                    <span className="text-muted-foreground line-through">{product.price.toFixed(2)} Dh</span>
                    <Badge variant="secondary" className="bg-tactical-light text-white">
                      -{Math.round((1 - product.discountPrice! / product.price) * 100)}%
                    </Badge>
                  </>
                ) : (
                  <span className="text-2xl font-bold">{product.price.toFixed(2)} Dh</span>
                )}
              </div>
