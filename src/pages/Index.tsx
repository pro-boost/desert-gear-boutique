            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 scroll-animate">
                ...
                <p className="text-lg mb-8 text-muted-foreground max-w-md">
                  Le meilleur équipement militaire et tactique pour les
                  professionnels et les passionnés.
                </p>
              ...
              <div className="md:w-1/2 scroll-animate">
                <div className="aspect-w-16 aspect-h-9 relative rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
                  <img
                    src="public\images\army-soldiers-fighting-with-guns-defending-their-country-scaled-e1676996741346.jpg"
                    alt="Military equipments"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="scroll-animate">
                ...
                <p className="text-muted-foreground mb-4">
                  Nidal Boots est votre destination de confiance pour
                  l'équipement militaire et tactique de haute qualité. Depuis
                  notre fondation, nous nous sommes engagés à fournir les
                  meilleurs produits aux professionnels et aux passionnés.
                </p>
                <p className="text-muted-foreground mb-6">
                  Notre sélection comprend des bottes militaires robustes, des
                  vestes tactiques et des accessoires essentiels, tous
                  soigneusement choisis pour leur qualité et leur durabilité.
                </p>
