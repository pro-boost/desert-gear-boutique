...
const ProductActions: React.FC<ProductActionsProps> = ({
  ...
  return (
    <div className="flex flex-col flex-wrap gap-3 pt-4">
      <Button
        className="flex-1 min-w-auto sm:min-w-auto py-2 text-lg whitespace-normal break-words"
        disabled={isDisabled}
        onClick={onBuyNow}
      >
      ...
      <div className="flex gap-3 w-full sm:w-auto">
        ...
        <Button
          ...
          className="flex-1 sm:w-14 h-14 hover:bg-green-500/10 hover:text-green-500 hover:border-green-500/20 transition-colors"
        >
          <WhatsAppIcon />
        </Button>
      </div>
